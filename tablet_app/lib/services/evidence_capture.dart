...
class EvidenceShot {
  ...
  ///
  /// This is the number the race is about, so it is the one measured: the window
  /// between the judge pressing SEND and the pixels being grabbed. Writing the
  /// file afterwards cannot change what is in it.
  final int ms;
